#ifndef KRR_AGENT__ACTION_NEXT_ROOM_HPP_
#define KRR_AGENT__ACTION_NEXT_ROOM_HPP_
...
class NextRoom : public plansys2::ActionExecutorClient
{
public:
  NextRoom(const std::string & node_name,
...
private:
  ...
  rclcpp::CallbackGroup::SharedPtr callback_group_nav_client_;
