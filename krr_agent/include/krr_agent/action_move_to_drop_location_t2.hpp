#ifndef KRR_AGENT__ACTION_MOVE_TO_DROP_LOCATION_T2_HPP_
#define KRR_AGENT__ACTION_MOVE_TO_DROP_LOCATION_T2_HPP_
...
class MoveToDropLocation : public plansys2::ActionExecutorClient
{
public:
  MoveToDropLocation(const std::string & node_name,
    const std::chrono::nanoseconds & rate);

  virtual ~MoveToDropLocation();
